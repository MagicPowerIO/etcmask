 ...
 * @property {string} provider.type - An identifier for the type of network selected, allows ETCMask to use custom provider strategies for known networks.
 ...
 * @property {MetaMaskState} data - The data emitted from ETCMask controller, or used to initialize it.
 * @property {Number} version - The latest migration version that has been run.
 */

/**
 * Initializes the ETCMask controller, and sets up all platform configuration.
 ...
 * @returns {Promise<MetaMaskState>} Last data emitted from previous instance of ETCMask.
 */
...
/**
 * Initializes the ETCMask Controller with any initial state and default language.
...
function setupController (initState, initLangCode) {
  ...
  /**
   * Connects a Port to the ETCMask controller via a multiplexed duplex stream.
...
// On first install, open a window to ETCMask website to how-it-works.
