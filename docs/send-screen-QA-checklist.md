...
## Send Eth mode
  ...
  - [ ] **From row** _It should:_
    ...
    - [ ] contain the following info for each account: identicon, account name, balance in ETC, balance in current currency
  ...
  - [ ] **Amount row** _It should:_
    ...
    - [ ] display 'ETC' after the number amount. The position of 'ETC' should change as the length of the input amount text changes
    - [ ] display the value of the amount of ETC in the current currency, formatted in that currency
  ...
  - [ ] **Gas Fee Display row** _It should:_
    ...
    - [ ] display the fee in ETC and the current currency
...
## Edit send Eth mode
  ...
  - [ ] Otherwise, behave the same as 'Send ETC mode' (see above)
