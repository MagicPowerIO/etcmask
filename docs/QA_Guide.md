...
* Load older version of ETCMask and attempt to simulate updating the extension.
...
* Token Management
    ...
    * Send that token to another etcmask address.
...
* Ganache set blocktime to simulate retryTx in ETCMask
